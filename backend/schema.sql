...
-- Database: dacn_db  (already created — run this script INSIDE it)
-- Generated from TypeORM entities in backend/src/**/entities/*.entity.ts
--
-- How to run (no CREATE DATABASE / \connect — pure SQL query):
--   pgAdmin: open a Query Tool on the dacn_db database, paste/run this file.
--   psql:    psql -U postgres -h localhost -d dacn_db -f backend/schema.sql
--
